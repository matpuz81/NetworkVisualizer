    ...
    private boolean createDbStruckture() {
        try {
            ...
            String sql = "CREATE TABLE IF NOT EXISTS NetworkType (\n"
                    ...
                    + "  Node_ip_address1 VARCHAR(15) NOT NULL,\n"
                    + "  PRIMARY KEY (Node_ip_address, Node_ip_address1),\n"
                    + "   \n"
                    + "    FOREIGN KEY (Node_ip_address)\n"
                    + "    REFERENCES Node(ip_address),\n"
                    + "     \n"
                    + "    FOREIGN KEY (Node_ip_address1)\n"
                    + "    REFERENCES Node(ip_address)\n"
                    + ");\n"
                    + "   \n"
                    ...
                    + "  PRIMARY KEY (Node_ip_address, Network_id_network, NetworkLink_id_net_link),\n"
                    + "    FOREIGN KEY (Node_ip_address)\n"
                    + "    REFERENCES Node(ip_address),\n"
                    + "    FOREIGN KEY (Network_id_network)\n"
                    + "    REFERENCES Network(id_network),\n"
